...
public enum ErrorMessage {
    ...
    ITEM_NOT_FOUND("PCI item not found with id %d"),
    ...
    INVALID_NUMBER_OF_ITEMS("Group items can't be empty"),
    INVALID_GROUP_SIZE("Group size needs to be at least 2 for each"),

    TWO_OPTIONS_SAME_RELEVANCE("Diferent options must have diferent relevances"),
