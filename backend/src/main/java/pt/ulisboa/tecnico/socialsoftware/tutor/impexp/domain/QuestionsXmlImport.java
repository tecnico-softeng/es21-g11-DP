...
public class QuestionsXmlImport {
    ...
    private QuestionDetailsDto importOpenAnswerQuestion(Element questionElement) {
        ...
        openAnswerQuestionDto.setCorrectAnswer(questionElement.getAttributeValue("correctAnswer"));
        return openAnswerQuestionDto;
    }

    private QuestionDetailsDto importPCIQuestion(Element questionElement) {
        return null;
    }
